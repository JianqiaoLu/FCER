function results = run_FCER(seq, res_path, bSaveImage)
...
params.refinement_iterations = 3;       % Number of iterations used to refine the resulting position in a frame
...
%van新增参数
params.van_num = 5;%取值为正整数且大于1（等于1时相当于没有s）
% Run tracker
